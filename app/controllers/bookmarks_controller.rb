class BookmarksController < ApplicationController
  ...
  def search_bookmarks
    # Searches for all bookmarks tagged with the values passed on the search string
    ...
    # When getting the hidden variable from the form for the users to include ...
    # ... you might get "value" appended to the string before the param that you
  ...
  # Copy a bookmark from some one else's repository.
  def copy_bookmark
    b_url =  params[:b_url]
    b_title = params[:b_title]
    b_tags_text = params[:b_tags_text]
